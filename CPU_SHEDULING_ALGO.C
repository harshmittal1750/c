                        ...
                        Projects
                            Wiki
                                Security
                                    Insights
                                        operating -
        systems - c - programs - / all menu driven c programs
                                     @challakarthik9
                                         challakarthik9 Create all menu driven c programs
                                             Latest commit 48208b6 on 25 Dec 2018 History 1 contributor 8544 lines(7375 sloc) 195 KB
...
ALGORITHM
Step1 : START.Step2 : Let Work and Finish be vectors of length ‘m’ and ‘n’ respectively.Initialize : Work = Available, Finish[i] = false; for i=1,2,……,n
...
Print the sorted data
    Step 7 : For function
             ...
             loop from i = 0 to n
             Step 8 : Display Menu
                      Step 9 : Goto step 4 until choice = 3 Step 10 : END
...
5.If(no of rows and columns of matrix1 == no of rows and column of matrix 2)6.It can undergo addition and subtraction.7.If the above valid and the condition(no of columns of matrix1 == no of rows of matrix 2) 8.It can undergo multiplication as well.condition i < total col of matrix1
    condition i < total row of matrix2
                  9.all the required Functions.int i,
    j;
printf("\n\n");
for (i = 0; i < 3; i++)
{
